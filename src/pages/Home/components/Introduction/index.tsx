...
import IntroductionFeatures from '../../../../components/ColumnsFormatting/IntroductionFeatures'; //edited part => for mobile
import IntroductionFeaturesImage from '../../../../components/ColumnsFormatting/IntroductionFeaturesImage'; //edited part => for desktop/tablet
import IntroductionFeaturesText from '../../../../components/ColumnsFormatting/IntroductionFeaturesText'; //edited part => for desktop/tablet
